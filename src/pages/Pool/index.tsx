        ...
        <AutoColumn gap="lg" justify="center">
          <CardBody>
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              <RowBetween className='bg_trans_new_icon' padding="0 8px">
              ...
              {!account ? (
                <LightCard padding="40px" className="card_bg_1">
                  <Text className="card_bg_1_text" color="textDisabled" textAlign="center">
                    {TranslateString(156, 'Connect wallet to view your liquidity.')}
                  </Text>
                </LightCard>
              ) : v2IsLoading ? (
                <LightCard padding="40px" className="card_bg_1">
